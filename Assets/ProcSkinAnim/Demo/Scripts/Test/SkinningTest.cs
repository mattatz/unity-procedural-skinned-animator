...
namespace ProcSkinAnim.Demo
{
    ...
    public class TRS
    {
        public Vector3 T { get { return translation; } }
        public Quaternion R { get { return rotation; } }
        public Vector3 S { get { return scale; } }
        public Matrix4x4 M { get { return Matrix4x4.TRS(T, R, S); } }
        public Matrix4x4 IM { get { return M.inverse; } }
        ...
        public TRS(Transform tr) : this(tr.position, tr.rotation, tr.lossyScale) {}
    }
